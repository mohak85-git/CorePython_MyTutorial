...
# The track number of the song "Kentish Town Waltz" from the Imelda May album 
# "More Mayhem".
# The tuple representing the song "Keeping a Rendezvous" from the Budgie album 
# "Nightflight".
...
# Print only the values requested, don't include any additional text in your 
# output.
